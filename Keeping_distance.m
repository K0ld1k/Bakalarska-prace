...
clc
%% INICIALIZACE
% Pocet agentu, dimenze, meritko, pomer, reakcni vzdalenost
agents = 30; % <n>
dim = 2; % <dim>
d = 25; % <d>
K = 1.2; % <k>
...
% Rozmisteni agentu a vypocet jejich sousedu
a = 50;
b = 150;
aa = 20;
bb = 100;
...
% Prekazka a cil
Ms = [220 290  370 450;   %x 
       100 -80  90 -10;   %y
       65  90   55  10];  %radius 

target = [480,-10];
connections = 0; % Vizualizace interakcnich vazeb (1-on,0-off)
tolerance = 0.1; % Parametr zastavovaci podminky
...
for iteration = 1:length(t)
    ...
    % Kvadrat rychlosti pro graf a pocet iteraci
    if(iteration > 1)
...
xlabel("Osa X")
ylabel("Osa Y")
%% Graf trajektorie stredu shluku
figure
